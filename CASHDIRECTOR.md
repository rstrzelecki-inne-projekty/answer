...
| 8 | Dashboard: aktywność dzienna | `GET /answer/admin/api/activity-log/daily` (agregacja w strefie przeglądarki) + karta `Admin/Dashboard/components/DailyActivity` — 14 dni × (pytania, odpowiedzi, komentarze, review, odznaki, wyświetlenia), liczby linkują do logu z filtrem | PR https://github.com/apache/answer/pull/1625 (stacked na #1624, gałąź `feat/dashboard-daily-activity`) |
