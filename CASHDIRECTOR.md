...
|---|---|---|---|
| 5 | Przeładowanie przy nieaktualnym bundle | `ui/src/router/index.tsx`: nieudany `import()` strony (stary chunk po wdrożeniu → 404 z Caddy) przeładowuje kartę raz (`sessionStorage cd_stale_chunk_reload`), zamiast ekranu „50X” | kandydat do PR upstream (razem z 404 dla brakujących `/static/*`) |
