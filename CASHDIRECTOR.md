...
|---|---|---|---|
| 7 | Sortowanie „Najwięcej wyświetleń” | `order=views` na liście pytań (`question.view_count DESC`), przycisk w `QUESTION_ORDER_KEYS`, i18n `question.views` | lokalne; kandydat do PR upstream (mały) |
